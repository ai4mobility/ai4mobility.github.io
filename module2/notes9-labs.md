...
<div class="notes-card">
  ...
  <p class="notes-card-lede">What the module's lab <em>proves</em>, the bridge lab from Module 1 you should run first, and where transformers go from here. Everything on this page is practice &mdash; the explanations live in sections 2.1&ndash;2.8.</p>
...
- **What is the classical method this replaces, and has anyone run it?** Sections 2.2, 2.5 and 2.8.
  On two different real corpora in this module, counting words beats a frozen pretrained
  encoder.
- **What is the split?** Section 2.8. Agency text is written by a small number of people
...
Apart from the fine-tuning in section 2.5, this module uses pretrained transformers as they come. {doc}`Module 4 <../module4/index>`
...
half &mdash; the decoder-only models sketched in section 2.6 &mdash; into diffusion and world models.
